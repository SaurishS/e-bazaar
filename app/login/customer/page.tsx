  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user?.user_metadata?.role === 'seller') {
         ...
         throw new Error("This account is registered as a Seller. Please use the Seller Login.");
      }
  ...
  return (
    <div className="min-h-screen bg-vk-green-50 flex flex-col font-sans">
      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-12">
        <div className="bg-white rounded-[2rem] shadow-xl w-full max-w-4xl flex overflow-hidden min-h-[550px]">
          
          {/* Left Side: Form */}
          <div className="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center">
            <h1 className="text-3xl font-bold text-vk-green-600 mb-8 text-center">
              Customer Login
            </h1>
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full bg-vk-green-600 text-white font-bold py-4 rounded-full hover:bg-vk-green-700 shadow-lg shadow-vk-green-200 transition-all hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed"
              >
            ...
            <div className="flex gap-4">
              ...
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  ...
                  />
                  <path
                    d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.26-1.19-2.67z"
                    fill="#FBBC05"
                  />
                  <path
              ...
              {/* No Facebook as requested */}
            </div>

            <div className="mt-8 text-center text-sm text-gray-600">
              New to ValueKart?{" "}
              <Link href="/register/customer" className="text-vk-green-600 font-semibold hover:underline">
                Create an Account
              </Link>
            </div>
          </div>
            ...
            <div className="relative w-full h-full flex flex-col items-center justify-center">
                 ...
                 <div className="relative z-10 w-full flex flex-col items-center">
                    ...
                    <div className="text-center mt-4">
                        <h2 className="text-2xl font-bold text-vk-green-800 tracking-tight">Shop Smart.</h2>
                        <p className="text-vk-green-700/80 font-medium">Modular Living made affordable.</p>
                    </div>
                 </div>
            </div>
          </div>
